...
<section class="banniere">
    ...
    <div>
        <div class="boite-txt-sur-img">
            ...
            <img loading="lazy" src="{{path}}assets/img/jpeg/encherespecial1.jpg" alt="image enchere spéciales" />
        </div>
        ...
        <div class="boite-txt-sur-img">
            ...
            <img loading="lazy" src="{{path}}assets/img/jpeg/encheerespecial2.jpg" alt="image enchere spéciales" />
        </div>
        ...
        <div class="boite-txt-sur-img">
            ...
            <img loading="lazy" src="{{path}}assets/img/jpeg/encherespecial3.jpg" alt="image enchere spéciales" />
        </div>
    </div>
</section>
