{{ include('snippet/header.php', {title: 'Enchères en cours'}) }}


    <section class="banniere">
      <header class="titre-section">
        <h2>
          <span class="scribe">C</span>ollections spéciales en cours d'enchères
        </h2>
        <div></div>
      </header>

      <div>
        <div class="boite-txt-sur-img">
          <div class="boite-txt-sur-img_texte">
            <h3><a href="#"> Collection germanique</a></h3>
                ...
                >
                  ...
                  <g data-name="Layer 1">
                    <g>
                      <path
                        class="cls-1"
                        d="m0,18.19c0,.72.59,1.3,1.3,1.3h25.36l-9.91,9.84c-.52.52-.52,1.3,0,1.83.26.26.59.39.91.39s.65-.13.91-.39l12.12-12.06c.07-.07.13-.13.13-.2,0,0,0-.07.07-.07,0-.07.07-.13.07-.13v-.13c0-.07.07-.07.07-.13v-.26h0v-.26c0-.07-.07-.13-.07-.2v-.07c0-.07-.07-.13-.07-.2v-.07c-.07-.07-.13-.13-.13-.2l-12.19-12.06c-.52-.52-1.3-.52-1.83,0s-.52,1.3,0,1.83l9.91,9.91H1.3c-.72,0-1.3.59-1.3,1.3Z"
                      />
                      <path
                        class="cls-1"
                        d="m41.06,38.2V1.3c0-.72-.59-1.3-1.3-1.3h-9.91c-.72,0-1.3.59-1.3,1.3s.59,1.3,1.3,1.3h8.6v34.35h-8.6c-.72,0-1.3.59-1.3,1.3s.59,1.3,1.3,1.3h9.91c.72-.07,1.3-.65,1.3-1.37Z"
                      />
                    </g>
                  </g>
                </svg>
        ...
        <div class="boite-txt-sur-img">
          <div class="boite-txt-sur-img_texte">
            <h3><a href="#">États-Unis comptemporain</a></h3>
    ...
    <div class="page-double">
      <header>
        <div class="titre-section">
          <h2><span class="scribe">T</span>outes les enchères</h2>
          <div></div>
        </div>
      ...
      <aside>
            ...
            <li class="tags">
              ...
              >
                ...
                <g data-name="Layer 1">
                  <path
                    class="cls-1"
                    d="m36.9,0L0,36.9l28.08,28.08,36.9-36.9V0h-28.08Zm10.86,9.84c4.05,0,7.38,3.33,7.38,7.38s-3.33,7.38-7.38,7.38-7.38-3.33-7.38-7.38,3.33-7.38,7.38-7.38Z"
                  />
                </g>
              </svg>
            </li>
        ...
        <section>
          <h4>Par état de conservation</h4>
          <ul>
            <li class="tags">
              Oblitéré
              <svg
      ...
      <main class="grille-principale">
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Basler Taube</h4>
            <p>Suisse, 1845</p>
            <p>Prix d'enchère :<span> 159 $</span></p>
            ...
            <a href="#" class="button-1">Voir ce timbre</a>
          </div>
        </article>
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>One-Cent Magenta</h4>
            <p>Guyane britannique, 1856</p>
            <p>Prix d'enchère : <span>159 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Mauritius "Post Office"</h4>
            <p>Île Maurice, 1847</p>
            <p>Prix d'enchère : <span>159 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Basler Taube</h4>
            <p>Suisse, 1845</p>
            <p>Prix d'enchère :<span> 318 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
                <svg
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Basler Taube</h4>
            <p>Suisse, 1845</p>
            <p>Prix d'enchère :<span> 200 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
                <svg
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Basler Taube</h4>
            <p>Suisse, 1845</p>
            <p>Prix d'enchère :<span> 799 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
                <svg
        ...
        <article class="boite-timbre">
          ...
          <div class="timbre-info">
            <h4>Basler Taube</h4>
            <p>Suisse, 1845</p>
            <p>Prix d'enchère :<span> 860 $</span></p>
            <div class="icone-text timbre">
              <figure>
                <div></div>
                <svg
