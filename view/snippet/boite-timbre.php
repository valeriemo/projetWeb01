<article class="boite-timbre">
    ...
    <div class="timbre-info">
        <div class="timbre-info_header">
            <div>
                <h4>{{ enchere.nomTimbre|capitalize }}</h4>
                <p>{{ enchere.paysOrigine|capitalize }}</p>
                <p> {{ enchere.anneeEmission }}</p>
            </div>
            {% if enchere.coupDeCoeur == 1 %}
            <figure><img src="{{path}}assets/img/svg/icone/coupDeCoeur.svg" alt=""></figure>
            {% endif %}
        </div>
        ...
        <p>L'enchère se termine dans {{enchere.tempsRestant.d}} jours</p>
